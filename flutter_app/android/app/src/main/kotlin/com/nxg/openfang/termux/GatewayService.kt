...
class GatewayService : Service() {
    ...
    private fun startGateway() {
        ...
        Thread {
            try {
                ...
                gatewayProcess = pm.startProotProcess("/root/.local/bin/openfang start")
    ...
    private fun updateNotificationRunning() {
        updateNotification("Running on port 4200 \u2022 ${formatUptime()}")
    }
    ...
    private fun createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel = NotificationChannel(
                ...
                description = "Keeps the OpenFang daemon running in the background"
            }
